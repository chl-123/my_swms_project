...
public class ResourceController {
    ...
    public Result<List<Resource>> queryResourceTree(String parentId) {
    ...
    @ApiImplicitParam(paramType = "path", name = "resId", value = "权限资源ID", required = true, dataType = "String")
    public Result<?> deleteResource(@PathVariable("resId") String resId) {
