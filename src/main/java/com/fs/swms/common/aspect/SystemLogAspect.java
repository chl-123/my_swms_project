package com.fs.swms.common.aspect;

import com.alibaba.fastjson.JSON;
import com.fs.swms.common.annotation.log.AfterLog;
import com.fs.swms.common.annotation.log.AroundLog;
import com.fs.swms.common.annotation.log.BeforeLog;
...
public class SystemLogAspect {
     ...
     * Before切点
     */
    @Pointcut("@annotation(com.fs.swms.common.annotation.log.BeforeLog)")
     ...
     * After切点
     */
    @Pointcut("@annotation(com.fs.swms.common.annotation.log.AfterLog)")
     ...
     * Around切点
     */
    @Pointcut("@annotation(com.fs.swms.common.annotation.log.AroundLog)")
